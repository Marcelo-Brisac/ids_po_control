...
> **PREREQUISITE:** Read `../gws-shared/SKILL.md` for invocation, authentication, global flags, and security rules.

```bash
./scripts/gws drive <resource> <method> [flags]
```
...
./scripts/gws drive --help

# Inspect a method's required params, types, and defaults
./scripts/gws schema drive.<resource>.<method>
```
