...
**Note**: Skills referenced in a knowledge's `CLAUDE.md` are already bundled inside its installation directory (e.g., `.mule_knowledge/<knowledge_name>/`). Do NOT re-install them via skill-finder.
