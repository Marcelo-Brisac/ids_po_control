...
| Muledance 2.0 T2V | `models/mule/muledance-2-0-t2v/generation.py` | Brand-wrapped Doubao Seedance 2.0 T2V, 480p/720p/1080p, 4-15s, native audio |
| Muledance 2.0 Fast T2V | `models/mule/muledance-2-0-fast-t2v/generation.py` | Fast variant: 480p/720p only, lower latency/cost |
...
| Muledance 2.0 I2V | `models/mule/muledance-2-0-i2v/generation.py` | Brand-wrapped Doubao Seedance 2.0 I2V, first-frame + optional last-frame, 480p/720p/1080p |
| Muledance 2.0 Fast I2V | `models/mule/muledance-2-0-fast-i2v/generation.py` | Fast variant: 480p/720p only, lower latency/cost |
...
| Muledance 2.0 R2V | `models/mule/muledance-2-0-r2v/generation.py` | Brand-wrapped Doubao Seedance 2.0 R2V; up to 9 images / 3 videos / 3 audios as references |
| Muledance 2.0 Fast R2V | `models/mule/muledance-2-0-fast-r2v/generation.py` | Fast variant: 480p/720p only, lower latency/cost |
